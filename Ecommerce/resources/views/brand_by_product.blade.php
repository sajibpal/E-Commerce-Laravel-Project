...
@section('contain') 
               <!--features_items-->
                 <h2 class="title text-center">Features Items</h2>
                  ...
                  <?php
                    foreach (  $product_brand as $product_value) { ?>
                        <div class="col-sm-4">
                            <div class="product-image-wrapper">
                                <div class="single-products">
                                        <div class="productinfo text-center">
                                            <img src="{{URL::to($product_value->product_image) }}" style="height: 180px; width: 180px;"></td>
                                            <h4>{{$product_value->product_price}}(Tk)</h4>              <p>{{$product_value->product_name}}</p>
