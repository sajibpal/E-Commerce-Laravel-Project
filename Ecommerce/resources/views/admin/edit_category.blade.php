			...
			<div class="row-fluid sortable">
				<div class="box span12">
					...
					<div class="box-content">
						<form  method="post" action="{{url('/update_category/'.$data->id)}}"  class="form-horizontal">
						  ...
						  <fieldset>
							<div class="control-group">
							  ...
							  <div class="controls">
								<input type="text" class="input-xlarge" name="Category_name" id="" value="{{$data->category_name}}">
							  </div>
							</div>
                             <div class="control-group hidden-phone">
							  <label class="control-label" for="textarea2">Category Details</label>
							  <div class="controls">
								<textarea class="cleditor" name="Category_details" id="textarea2" rows="3">{{$data->category_descption}}</textarea>
							  </div>
							</div>
							<div class="control-group">
